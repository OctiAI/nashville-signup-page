      ...
      <div className="relative z-10">
        ...
        <header className={`pt-8 pb-4 transition-all duration-700 delay-100 ${
         ...
         <img 
              ...
              className="h-40 mx-auto mb-6 transform scale-100"
            />
                  ...
                  {[
                    ...
                    <div key={index} className={`flex items-start gap-3 transition-all duration-500 ${
                      ...
                      <span className="text-gray-700 font-medium">
                        {index === 0 ? (
                          <>
                            We'll give you a <span className="text-black font-bold">Super Mega Giga Detailed Quote™</span>—no surprises, no hidden fees, just a clear, honest price.
                          </>
                        ) : (
                          item
                        )}
